...
if(i%20==1)
     $.ajax({
                url: "http://[2001:da8:a0:500::1:9]:8089/memory7",
                crossDomain:true,
                dataType: 'JSONP',
                type: 'GET',
                //method: 'GET',
		...
		for( x in data2){
                ...
                function DrawEcharts2 (ec) {
                        var myChart1 = ec.init(document.getElementById('memory-chart7'));
...
if(i%20==2)
        $.ajax({
                url: "http://[2001:da8:a0:500::1:9]:8089/centosdisk7",
                crossDomain:true,
                dataType: 'JSONP',
                type: 'GET',
                //method: 'GET',
		...
		for( x in data2){
                ...
                function DrawEcharts2 (ec) {
                        var myChart1 = ec.init(document.getElementById('centosdisk-chart7'));
